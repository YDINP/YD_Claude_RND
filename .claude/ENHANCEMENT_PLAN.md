...
- [ ] D-1 (미학적 방향 프로세스 3단계) 추가 완료
- [ ] D-1 (프로덕션 품질 체크리스트 5항목) 추가 완료
- [ ] D-1 (Generic AI Slop 금지 패턴 5항목) 추가 완료
- [ ] D-2 (외부 가이드라인 참조 패턴) 추가 완료
- [ ] 기존 MD3/Compose/AnimationSpec 패턴과 중복 없음 확인
- [ ] 기존 168줄 대비 +60줄 이내 유지
...
- [ ] W-4 (7-Sweep 체크리스트 7항목) 추가 완료
- [ ] W-4 (금지 표현 → 대체 방식 4항목) 추가 완료
- [ ] W-1(KDoc)/W-2(CHANGELOG)/W-3(ADR) 기존 내용 손상 없음
- [ ] 기존 197줄 대비 +40줄 이내 유지
...
- [ ] PL-4 (분해 기준 체크리스트 4항목) 추가 완료
- [ ] PL-4 (작업 단계 분해 템플릿) 추가 완료
- [ ] PL-4 (명확화 질문 패턴 3단계) 추가 완료
- [ ] PL-4 (좋은/나쁜 분해 예시) 추가 완료
- [ ] 기존 108줄 대비 +50줄 이내 유지
...
- [ ] RS-4 (E-E-A-T 4요소 평가 표) 추가 완료
- [ ] RS-4 (출력 표기 표준) 추가 완료
- [ ] RS-4 (LOW 출처 처리 원칙) 추가 완료
- [ ] RS-2 (CVE 조회 프로세스) 기존 내용 손상 없음
- [ ] 기존 89줄 대비 +40줄 이내 유지
