...
export const DESIGN = {
  ...
  // ----------------------------------------
  // BA/NIKKE 하이브리드 배경 색상 토큰
  // ----------------------------------------
  background: {
    primary:   '#0A0A1A',  // 딥 네이비 블랙
    secondary: '#12122A',  // 다크 퍼플
    card:      '#1A1A3E'   // 다크 블루 퍼플
  },
  ...
  // ----------------------------------------
  accent: {
    neon: '#00F5FF',  // neon_crow 교단 컬러 = 하이라이트
    gold: '#FFD700'   // SSR 등급 컬러
  },
