...
const ko: Record<TranslationKey, string> = {
  ...
  freeSpinsPopupTitle: '프리스핀!',
  freeSpinsPopupSpins: '프리스핀 {spins}회',
  freeSpinsPopupSpinsWithMultiplier: '프리스핀 {spins}회 ×{multiplier}',
  freeSpinsPopupTotal: '총 획득 {amount}',
  popupTapToClose: '탭하면 닫혀요',
  popupTapToSkip: '탭하면 바로 보여요',
  freeSpinsPopupCountUnit: '회',
  freeSpinsPopupMultiplierLabel: '배수 ×{multiplier}',
  winTierPlain: '획득',
  winTierSurge: 'SURGE',
  winTierBlast: 'BLAST',
  winTierStorm: 'STORM',
  ...
  gambleStakeLabel: '걸린 금액',
  gamblePayoutChip: '×{payout} 배당',
  gambleChanceChip: '성공 확률 {percent}%',
  gambleTossing: '던지는 중…',
