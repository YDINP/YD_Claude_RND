...
/** 정지 시 살짝 지나쳤다 되돌아오는 거리(심볼 단위). */
export const OVERSHOOT_SYMBOLS = 0.32
/** 되돌아오는 바운스에 쓰는 시간 비율 (전체 스핀 길이 대비). */
export const BOUNCE_PORTION = 0.16
...
/** 페이라인 선 두께 = 심볼 한 변 x 이 값. */
export const WIN_LINE_WIDTH_RATIO = 0.06
